  ...
  return (
    <section id="projects" className="pt-8 pb-20 px-4 xl:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-off-white backdrop-blur-sm rounded-lg p-6 mb-12 shadow-lg scroll-fade-in">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="order-1 text-left">
                ...
                <div className="text-center xl:text-left mb-4">
                  <span className="text-sepia-alt font-mono text-sm">July 2025</span>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-2 text-left lg:text-right">
                ...
                <div className="text-center xl:text-right mb-4">
                  <span className="text-sepia-alt font-mono text-sm">Aug 2025</span>
                </div>
          ...
          <div className="scroll-slide-left">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-1 text-left">
                ...
                <div className="text-center xl:text-left mb-4">
                  <span className="text-sepia-alt font-mono text-sm">2024</span>
                </div>
                <div className="hidden md:flex space-x-6 justify-center xl:justify-start">
                  <a href="https://github.com/zoyab522/411-PS6/blob/main/CSC411_ProblemSet06/src/edu/ncsu/csc411/ps06/agent/Robot.java" target="_blank" rel="noopener noreferrer" className="text-sepia-alt hover:text-sepia-dark transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-12 scroll-fade-in">
            ...
            <a href="https://pokedex-black-one.vercel.app/" target="_blank" rel="noopener noreferrer" className="project-folder">
              <div className="flex-1 flex flex-col justify-between h-full">
                ...
                <div className="text-center mb-4">
                  <span className="text-sepia-alt font-mono text-sm">2023</span>
                </div>
              </div>
            </a>
            ...
            <a href="https://zoyab522.github.io/MachineLearning/MLPage.html" target="_blank" rel="noopener noreferrer" className="project-folder">
              <div className="flex-1 flex flex-col justify-between h-full">
                ...
                <div className="text-center mb-4">
                  <span className="text-sepia-alt font-mono text-sm">2021</span>
                </div>
              </div>
            </a>
            
            {/* Blender Donut Project */}
            <div className="project-folder blender-project cursor-pointer lg:cursor-default" onClick={() => setFullScreenImage('/assets/final_images/digital/Donut.png')}>
              <div className="flex-1 flex flex-col justify-between h-full">
                <div className="flex justify-between items-start mb-3">
                  <div className="w-8 h-8">
                    <svg className="w-full h-full text-sepia-alt" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <div className="flex space-x-2">
                    <a href="https://www.blender.org/" target="_blank" rel="noopener noreferrer" className="text-sepia-alt hover:text-sepia-dark transition-colors">
                ...
                <div className="text-center mb-4">
                  <span className="text-sepia-alt font-mono text-sm">2022</span>
                </div>
              </div>
            </div>
            ...
            <a href="https://github.com/zoyab522/Personal-Website-Portfolio" target="_blank" rel="noopener noreferrer" className="project-folder">
              <div className="flex-1 flex flex-col justify-between h-full">
                ...
                <div className="text-center mb-4">
                  <span className="text-sepia-alt font-mono text-sm">Sept 2025</span>
                </div>
              </div>
            </a>

            {/* Personal Site Archived Version */}
            <a href="https://zoyab522.github.io/personal-site-v0/Homepage.html" target="_blank" rel="noopener noreferrer" className="project-folder">
              <div className="flex-1 flex flex-col justify-between h-full">
                <div className="flex justify-between items-start mb-3">
                  <div className="w-8 h-8">
                    <svg className="w-full h-full text-sepia-alt" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <div className="flex space-x-2">
                    <a href="https://github.com/zoyab522/personal-site-v0" target="_blank" rel="noopener noreferrer" className="text-sepia-alt hover:text-sepia-dark transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                      </svg>
                    </a>
                    <a href="https://zoyab522.github.io/personal-site-v0/Homepage.html" target="_blank" rel="noopener noreferrer" className="text-sepia-alt hover:text-sepia-dark transition-colors">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                      </svg>
                    </a>
                ...
                <p className="text-dark-brown-alt mb-4 leading-relaxed text-sm md:text-base">
                  My first portfolio site I ever made 🌱. I really just wanted to learn how to add parallax scrolling effects to pages, but here we are :)
                </p>
                <ul className="text-dark-brown-alt text-sm space-y-1 mb-4">
                  <li>• Vanilla CSS, JS, HTML</li>
                  <li>• <strong>Basic Media Queries</strong> for responsiveness</li>
                </ul>
                <div className="flex flex-wrap gap-2 mb-4 archive-project-tags">
                  <span className="px-3 py-1 text-dark-brown-alt rounded-full text-sm font-mono">
                    JS Mouse Effect
      ...
      {fullScreenImage && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-90 flex items-center justify-center lg:hidden">
          <div className="relative w-full h-full flex items-center justify-center p-4">
            ...
            <button
              ...
              className="absolute top-4 right-4 text-white !text-white text-4xl font-bold hover:text-gray-300 transition-colors"
            >
              ×
            </button>
          </div>
  ...
  return (
    <footer className="pt-20 pb-20 px-4 xl:px-6 px-20">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="xl:hidden flex justify-center space-x-6">
          <a href="https://github.com/zoyab522" target="_blank" rel="noopener noreferrer" 
             className="text-sepia-alt hover:text-sepia-dark transition-colors hover:transform hover:translate-y-[-2px]">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
